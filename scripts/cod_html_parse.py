...
from src.cif_utils import get_smiles_from_id_on_web
...
if __name__ == "__main__":
    ...
    for i, id in tqdm(enumerate(cifs_id), total=len(cifs_id), desc="Processing COD IDs"):
        ...
        try:
            ...
            time.sleep(random.uniform(0.2, 0.5))  # Random sleep
